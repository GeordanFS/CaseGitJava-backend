...
public class SwaggerConfig {
	...
	public OpenAPI springBlogPessoalOpenAPI() {
        ...
        return new OpenAPI()
				.info(new Info()
					.title("Case Itaú")
					.description("Repositórios Git Java")
					.version("v0.0.1")
				.license(new License()
					.name("Geordan Fagundes")
					.url("https://linkedin/in/geordanfagundes"))
				.contact(new Contact()
					.name("Geordan")
					.url("https://github.com/GeordanFS")
					.email("geordansantos@gmail.com")))
